...
def get_arguments():
    ...
    parser.add_argument('--camera_color_names', action='store', type=str, help='camera_color_names',
                        default=['down', 'front', 'left', 'right'],
                        required=False)
    parser.add_argument('--camera_color_topics', action='store', type=str, help='camera_color_topics',
                        default=['/camera_down/color/image_raw', '/camera_f/color/image_raw', '/camera_l/color/image_raw', '/camera_r/color/image_raw'],
                        required=False)
    ...
    parser.add_argument('--arm_joint_state_names', action='store', type=str, help='arm_joint_state_names',
                        default=['puupet_arm_left', 'puupet_arm_right', 'puupet_gripper_left', 'puupet_gripper_right'],
                        required=False)
    parser.add_argument('--arm_joint_state_topics', action='store', type=str, help='arm_joint_state_topics',
                        default=['/rm_left/joint_states', '/rm_right/joint_states', '/dh_left/gripper/joint_states', '/dh_right/gripper/joint_states'],
                        required=False)
    ...
    parser.add_argument('--lift_motor_topics', action='store', type=str, help='lift_motor_topics',
                        default=['/lifter_1/LiftMotorStatePub'],
                        required=False)
